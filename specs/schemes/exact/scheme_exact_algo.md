...
Example Facilitator Logic Signature:

```TEAL
#pragma version 12

// Validate feePayer's signature
txn TxID
int 0
args
addr FACILITATORADDRESSAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAALQCXBZE
ed25519verify_bare
assert
...
// Amount must be 0 Algo
txn Amount
int 0
==
assert

// Fee must be 2x MinTxnFee
txn Fee
global MinTxnFee
int 2
*
