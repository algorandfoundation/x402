...
// Dynamic pricing function based on HTTP request context
const dynamicPrice = (context: { adapter: { getQueryParam?: (param: string) => string | undefined } }) => {
  ...
  paymentMiddleware(
    {
      "GET /weather": {
        accepts,
        description: "Weather data with dynamic pricing",
