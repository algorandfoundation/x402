...
import { ExactAvmScheme as ExactAvmClient, ALGORAND_TESTNET_CAIP2, USDC_TESTNET_ASA_ID, DEFAULT_ALGOD_TESTNET } from "../../src";
...
const CLIENT_ADDRESS = algosdk.encodeAddress(clientSecretKey.slice(32));
