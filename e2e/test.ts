...
async function runTest() {
  ...
  const systemManagedVars = new Set(['PORT', 'AVM_PRIVATE_KEY', 'AVM_NETWORK', 'AVM_RPC_URL', 'EVM_PRIVATE_KEY', 'SVM_PRIVATE_KEY', 'APTOS_PRIVATE_KEY', 'EVM_NETWORK', 'SVM_NETWORK', 'APTOS_NETWORK', 'EVM_RPC_URL', 'SVM_RPC_URL', 'APTOS_RPC_URL']);
